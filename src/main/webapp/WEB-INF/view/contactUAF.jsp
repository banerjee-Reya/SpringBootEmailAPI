...
<%@ include file="common/header.jsp"%>
	<!-- <nav class="navbar navbar-expand-sm bg-dark navbar-dark">
	  <a class="navbar-brand" href="#">Mail with Default PDF File</a>
	  <ul class="navbar-nav ml-auto">
	    ...
	    <li class="nav-item">
	      ...
	      <div class="dropdown-menu">
        	<a class="dropdown-item" href="#">Upload PDF File</a>
		...
		<div class="row justify-content-center align-items-center" style="height:auto;">
			<div class="col-4">
				<div class="card bg-light">
					...
					<div class="card-body">
						<form action="uploadFileEmailSend" method="post" enctype="multipart/form-data">
